...
Coffee Application in that:
- Each Coffee has id, title, description, published status.
- We can create, retrieve, update, delete Coffees.
- There is a Search bar for finding Coffees by title.
